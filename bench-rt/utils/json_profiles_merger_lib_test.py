...
class JsonProfilesMergerLibTest(unittest.TestCase):
    def test_accumulate_event_duration(self):
        event_list_1 = [
            ...
            {"cat": "fake_cat", "name": "fake_name", "dur": 3, "non_dur": "something"},
        ]
        ...
        event_list_2 = [
            ...
            {"cat": "fake_cat", "name": "fake_name", "dur": 1, "non_dur": "something"},
        ]
        ...
        self.assertEqual(
            {
                "fake_name": {"cat": "fake_cat", "name": "fake_name", "dur_list": [3]},
            },
            accum_dict,
        )
        lib._accumulate_event_duration(event_list_2, accum_dict)
        self.assertEqual(
            {"fake_name": {"cat": "fake_cat", "name": "fake_name", "dur_list": [3, 1]}},
            accum_dict,
        )
    ...
    def test_accumulate_build_phase_marker(self):
        event_list_3 = [
            ...
            {"cat": "build phase marker", "name": "phase1", "ts": 1000},
            {"cat": "build phase marker", "name": "phase2", "ts": 10000},
            {
                "cat": "fake_cat",
                "name": "fake_name",
                "dur": 1,
        ...
        self.assertEqual(
            {
                ...
                "fake_name": {"cat": "fake_cat", "name": "fake_name", "dur_list": [1]},
            },
            accum_dict,
        )
